...
X Linux: perfil archiso + instalador de texto. La planificacion principal vive
en el `ROADMAP.md` de la raiz del workspace (x-lnux).

## Estado

- Calamares eliminado; instalador de texto configurable (perfiles full/core,
